...
class OrderCreationTest {
 @Test void checkoutPersistsPriceSnapshotsAndCalculatedTotal(){
  ...
  assertThat(result.subtotal()).isEqualByComparingTo("24.50");assertThat(result.deliveryFee()).isEqualByComparingTo("2.50");assertThat(result.total()).isEqualByComparingTo("27.00");
